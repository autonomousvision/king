...
class LeaderboardEvaluator(object):
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        if int(os.environ['INCREMENT_DP_SEED']):
            CarlaDataProvider._rng = random.RandomState(int(args.dataProviderSeed)+config.index)
        ...
        try:
            ...
            route_name = f'{Path(args.routes).stem}/{config.name}'
            self.agent_instance = getattr(self.module_agent, agent_class_name)(args.agent_config, route_name)
...
def main():
    ...
    parser.add_argument('--dataProviderSeed', default='0',
                        help='Seed used by the DataProvider (default: 0)')
    parser.add_argument('--debug', type=int, default=0, help='Run with debug output')
